...
class ilStartingPoint
{
	...
	function save()
	{
		...
		$ilDB->manipulateF( "INSERT INTO usr_starting_point (id, starting_point, starting_object, position, rule_type, rule_options) VALUES (%s, %s, %s, %s, %s, %s)",
	...
	function saveOrder($a_items)
	{
		...
		foreach($a_items as $id => $position)
		{
			...
			{
				$ilDB->manipulate("UPDATE usr_starting_point SET".
